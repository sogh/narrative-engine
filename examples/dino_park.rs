...
fn main() {
    ...
    let grammars = GrammarSet::load_from_ron(std::path::Path::new(
    ...
    print_scene(
        2,
        "1430 — Power Fluctuation Detected",
        "NARRATOR",
        &mut engine,
        &event2,
        &world,
    ...
    print_scene(
        3,
        "2247 — Perimeter Breach: Rex Paddock",
        "RADIO OPERATOR",
        &mut engine,
        &event3,
        &world,
    ...
    print_scene(
        5,
        "2301 — Discovery: Raptor Pen Integrity",
        "DR. GRANT",
        &mut engine,
        &event5,
        &world,
    ...
    print_scene(
        6,
        "2315 — Critical Failure: All Systems",
        "RADIO OPERATOR",
        &mut engine,
        &event6,
        &world,
