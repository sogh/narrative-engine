...
- `{possessive_standalone}` expands to the independent possessive ("hers", "his", "theirs", "its")
- `{reflexive}` expands to the reflexive pronoun ("herself", "himself", "themselves", "itself")
